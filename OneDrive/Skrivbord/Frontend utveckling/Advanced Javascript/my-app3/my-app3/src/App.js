...
//tokenDeath is set to false in state, when it is updated to true in componentDidUpdate then when user have been logged in 1 hour the user will automatically be logged out and send to Login page.
